import useAgencyProjectWrapperAnimation2 from "./hooks/useAgencyProjectWrapperAnimation2";
import { useIsHoverDevice } from "./hooks/useIsHoverDevice";
import { Link } from "react-router-dom";

function Agencyourprojectwrapper2({ images }) {
  // our project aniamtion start here
  const { wrapper2 } = useAgencyProjectWrapperAnimation2();
      ...
      <Link to={images?.image2?.href}>
        <article>
          <div className="our_project_wrapper_2 relative h-screen block ">
            ...
            <div
              ref={wrapper2}
              className="main_conatiner_2 relative w-full -mt-20  "
            >
              <div className="our_projects_info">
                <div className="our_projects_outer_2 group relative block cursor-pointer   w-[100vw] h-[100vh] overflow-hidden rounded-tl-[35px] rounded-tr-[35px] lg:rounded-tl-[37.5px]  lg:rounded-tr-[37.5px] xl:rounded-tl-[40px] xl:rounded-tr-[40px] 3xl:rounded-tl-[50px] 3xl:rounded-tr-[50px] ">
                  <div
                    ...
                    style={{
                      backgroundImage: isHover
                        ? ` url(${images.image2.src})`
                        : `url(${images.image2.small})`,
                    }}
                  ></div>
...
export default Agencyourprojectwrapper2;
